...
3.	Before modifying files, we recommend creation of an **issue** in Github to alert database owners about the changes intended to be made. This will avoid potential duplication of efforts and allow database owners to provide any necessary guidance.  
...
6.	Replace old files with updated files, and commit changes to the newly created branch.  
7.	Open a pull request by comparing changes across the master branch and the new branch.  
