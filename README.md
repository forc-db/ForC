...
*Original publications* associated with all data are given in the measurements table, and full citations are in the [bibliography file](). The references contained in the database are archived in the ForC-db group on Mendeley (https://www.mendeley.com/community/forc-db/), which is a public repository. PDFs of ForC-db references and associated intermediary data sheets will be stored in a [private repository](https://github.com/forc-db/References) (not yet complete), which is private because of copyright restrictions, with access available upon request.
