...
#I'm using this as a template to work on some figures -Madison Williams, Intern
# Clean environment ####
rm(list = ls())
...
# 
# 
category <-ifelse(MEASUREMENTS_filter$dominant.life.form %in% "woody+grass", "savanna", MEASUREMENTS$dominant.veg)
