...
legend(-130, -50, fill = rgb(matrix(0, nrow = 4, ncol = 3), alpha = c(255, 150, 100, 50), maxColorValue = 255), border = "transparent", legend = c("Evegreen", "Decidous", "MixedED", "Other"), bty = "n", title = expression(bold("Forest Cover")), xpd = NA)
